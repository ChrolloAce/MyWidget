(function () {
  ...
  function generalQuestions() {
    ...
    function showJobSpecificQuestions(parent) {
        ...
        const jobSpecificQuestions = createElement('div', 'form-group', null, { id: 'job-specific-questions' });
        ...
        if (quoteDetails.jobType === 'residential') {
            ...
            const heightLabel = createElement('label', null, 'Is it over 10 feet in height?');
        ...
        const checkbox = createElement('input', null, null, { type: 'checkbox', id: '_checkbox' });
        checkbox.addEventListener('change', () => {
            quoteDetails.requiresInsurance = checkbox.checked;
            validateQuestions();
        });

        insuranceGroup.appendChild(checkbox);
        insuranceGroup.appendChild(createElement('span', null, 'Does the job require insurance?'));
