(function () {
    ...
    function init() {
        ...
        loader.load(
            'https://raw.githubusercontent.com/ChrolloAce/MyWidget/main/Counters.gltf', // Model URL
            function (gltf) {
                model = gltf.scene;
                scene.add(model);
    ...
    function createColorButtons() {
        ...
        // Button to apply the wood texture
        const woodTextureButton = document.createElement('button');
